...
|---|---|
| Any file in `ai-dlc/skills/` | Generic — skills are copied verbatim into every project |
| Any `_template.md` file in `ai-dlc/ops/` | Generic — templates are shared across all projects |
| `ai-dlc/rules/engagement.md` | Generic — copied verbatim into every project |
| `ai-dlc/setup-guide.md` | Generic — the shared framework specification |
| `ai-dlc/onboard.md` | Generic — the shared onboarding protocol |
| `ai-dlc/rules/prompt-quality-gate.md` | Likely generic — evaluate content |
| `ai-dlc/rules/code-standards.md` | Project-specific — encodes the project's tech stack |
| `ai-dlc/rules/security.md` | Project-specific — unless the finding addresses a universal pattern |
| `ai-dlc/rules/architecture.md` | Project-specific — encodes project ADRs |
| `ai-dlc/guidelines/domain-glossary.md` | Project-specific |
| `ai-dlc/guidelines/edge-cases.md` | Project-specific |
| `ai-dlc/guidelines/forbidden-zones.md` | Project-specific |
| `ai-dlc/guidelines/entry-points.md` | Project-specific |
| `ai-dlc/guidelines/acceptance-patterns.md` | Likely generic — evaluate content |
...
|---|---|
| `ai-dlc/skills/[skill].md` | `ai-dlc/skills/[skill].md` |
| `ai-dlc/ops/[path]/_template.md` | `ai-dlc/ops/[path]/_template.md` |
| `ai-dlc/rules/engagement.md` | `ai-dlc/rules/engagement.md` |
| `ai-dlc/rules/prompt-quality-gate.md` | `ai-dlc/rules/prompt-quality-gate.md` |
| `ai-dlc/setup-guide.md` | `ai-dlc/setup-guide.md` |
| `ai-dlc/onboard.md` | `ai-dlc/onboard.md` |
