...
If yes: run `ai-dlc/skills/bolt-risk-assessment.md` and record the blast radius in the bolt file.
...
Execute the unit. Review output using `ai-dlc/skills/review-checklist.md`.
...
3. If the bug was flagged as **recurring** in Step 2: read `ai-dlc/skills/root-cause-analysis.md` and run it now. Do not skip.
