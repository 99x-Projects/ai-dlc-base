...
**Standalone and needs-config skills** (usable immediately): Product Engineering Essentials, Solution Shaping, Design Session, Risk Assessment, UAT Sign-off, Root Cause Analysis, Hotfix Workflow, Process Visualization, Progress Digest, Knowledge Promotion, Notifications, AI Hub Metrics, Dependency Audit, Compact Docs, and Process Health.
