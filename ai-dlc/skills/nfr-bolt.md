...
Read `ai-dlc/ops/inception/dependency-map.md` and the backlog. Identify which existing intents or units touch the component being improved.
...
Run `ai-dlc/skills/bolt-risk-assessment.md` before any unit executes.
...
Execute units in the planned order. Review each unit's output using `ai-dlc/skills/review-checklist.md` before proceeding to the next.
