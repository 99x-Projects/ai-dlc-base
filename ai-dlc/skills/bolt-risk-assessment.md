...
Also read:
- `ai-dlc/rules/architecture.md` — to understand existing module boundaries and ADRs
- `ai-dlc/guidelines/forbidden-zones.md` — if it exists, to check whether any unit touches a protected zone
